        ...
        <teiHeader>
            <fileDesc>
                <titleStmt>
                    ...
                    <title level="m" xml:lang="en">MAJLIS: The Transformation of Jewish Literature in Arabic in the Islamicate World</title>
                    ...
                    <editor xml:id="mmoliere" role="contributor" ref="
                        ...
                        http://viaf.org/viaf/65156495392717561393">Maximilian de Molière</editor>
                    ...
                    <respStmt>
                        <resp>Conversion into TEI-XML format by</resp>
            ...
            <revisionDesc status="draft">
                ...
                <!-- FILE CREATOR -->
                <xsl:if test="index-of(tokenize(changelog,','),'1')"><change who="http://majlis.net/documentation/editors.xml#ngibson"
                 n="0.2"
